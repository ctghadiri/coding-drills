...
if (budget >= rentCost + untilitiesCost + foodCost + transportationCost + computerCost){
    console.log(rentCost, untilitiesCost, foodCost, transportationCost, computerCost);
}
else {
    console.log(rentCost + untilitiesCost + foodCost + transportationCost + computerCost);
}
...
if ((rentCost > untilitiesCost + foodCost + transportationCost) && (computerCost > rentCost + untilitiesCost)) {
